...
"""Requests-per-second helper using a sliding time window."""

from collections import defaultdict, deque


def rps(raw_logs, window_size):
    """Return max requests-per-second per endpoint over the provided window."""
