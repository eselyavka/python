    ...
    def compress(self, chars):
        ...
        while i < len(chars):
            ...
            if cnt > 1:
                buf = list(str(cnt))
                i += len(buf)
                [chars.insert(j, buf.pop()) for _ in range(len(buf))]
...
class TestSolution(unittest.TestCase):
    def test_compress(self):
        ...
        self.assertListEqual(chars, ["p","4","m","2","b","5","u","2","r","2","u","n","1","1","u","4","a","2","u","2","r","3","s","2","a","2","y","3","g","5"]);
